    ...
    \hbox to\pb@xwidth{%
      ...
      \hbox{%
          ...
          %\message{'pageno=\the\pageno, pixp@ageno=\the\pixp@geno'}
              ...
              \rem@inedwidth{#1} %
              \hskip\d@r \hfil %
              \vbox{\vfil \box0 \vskip9pt\vfil}% 
              \hfil \hskip\d@r %
              \rmultivrul@s %
          \else %左右加圖片框
          %\message{'pageno=\the\pageno, pixp@ageno=\the\pixp@geno'}
              %\hskip1.8pc 
                %\ifpagehdr\putp@gehdr\fi \hskip1pc %頁眉
              %\dblvlin@ %左第一框帶頁眉
...
\newbox\pghdr%
\TibHeaderBox=\pghdr%
\def\header{{\Black{\SamChe ༄༅\kern.01pt།\hskip2.7em plus .5em minus.5em།}}}%
